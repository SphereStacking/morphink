...
const alertVariants = cva(cn('relative w-full px-(--morphink-space-lg) py-(--morphink-space-md) flex gap-(--morphink-space-sm)'), {
  variants: {
    variant: {
  ...
  compoundVariants: [
    {
      tone: 'neutral',
      variant: 'solid',
      class: 'border border-(--morphink-border-width-default) border-(color:--morphink-color-neutral-foreground)',
    },
    {
      tone: 'neutral',
      variant: 'soft',
