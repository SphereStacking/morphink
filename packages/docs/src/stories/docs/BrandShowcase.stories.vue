    ...
    >
      ...
      <div
        style="
          ...
          width: 700px;
          height: 500px;
          background: radial-gradient(ellipse, rgba(248, 72, 94, 0.1) 0%, transparent 70%);
          pointer-events: none;
          z-index: 0;
        "
      ></div>
      ...
      >
        <Card variant="outline" rounded="lg" shadow="lg">
          <CardHeader>
            ...
            <CardDescription
              >Make changes to your profile here. Click save when you're done.</CardDescription
            >
          </CardHeader>
          <CardBody>
            <Stack direction="column" gap="md">
              ...
              <Button variant="solid" tone="success" size="sm" style="align-self: flex-end"
                >Save changes</Button
              >
            </Stack>
          </CardBody>
      ...
      >
        <img
          src="/ink-ui-logo.svg"
          alt="morphink"
          style="height: 80px; width: auto; filter: drop-shadow(0 4px 32px rgba(248, 72, 94, 0.35))"
        />
      </div>
          ...
          <CardBody>
            <Stack direction="column" gap="md">
              <Stack direction="row" gap="md" align="center">
                <div
                  style="
                    ...
                    height: 40px;
                    border-radius: 50%;
                    background: linear-gradient(135deg, #f8485e, #ff8a65);
                    display: flex;
                    align-items: center;
              ...
              <Text size="sm" color="muted"
                >Components, colors, and tokens for building accessible UI.</Text
              >
              <Stack direction="row" gap="lg">
                <Text size="xs"
                  ><strong>0</strong>
                  <span style="color: var(--morphink-color-muted-foreground)">Following</span></Text
                >
                <Text size="xs"
                  ><strong>&#x221E;</strong>
                  <span style="color: var(--morphink-color-muted-foreground)">Followers</span></Text
                >
              </Stack>
            </Stack>
          </CardBody>
