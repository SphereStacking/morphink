...
<template>
  <Story name="Default" :args="{ title: 'No results found', description: 'Try adjusting your search or filter to find what you are looking for.' }">
    <template #template="{ args }">
      <EmptyState v-bind="args" />
    </template>
  </Story>

  <Story name="WithAction" :args="{ title: 'No items yet', description: 'Get started by creating your first item.' }">
    <template #template="{ args }">
      <EmptyState v-bind="args">
        <template #action>
  ...
  <Story name="WithIcon" :args="{ title: 'No files uploaded', description: 'Drag and drop files here or click the button below.' }">
    <template #template="{ args }">
      <EmptyState v-bind="args">
        <template #icon>
