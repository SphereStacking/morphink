...
<template>
  <Story name="Default" :args="{ label: 'Dashboard', href: '/dashboard' }">
    <template #template="{ args }">
      <NavItem v-bind="args" />
    </template>
  </Story>

  <Story name="Active" :args="{ label: 'Dashboard', href: '/dashboard', active: true }">
    <template #template="{ args }">
      <NavItem v-bind="args" />
    </template>
  </Story>

  <Story name="WithBadge" :args="{ label: 'Notifications', href: '/notifications', badge: '5' }">
    <template #template="{ args }">
      <NavItem v-bind="args" />
    </template>
  </Story>

  <Story name="WithIcon" :args="{ label: 'Dashboard', href: '/dashboard', active: true }">
    <template #template="{ args }">
      <NavItem v-bind="args">
        <template #icon>
  ...
  <Story name="NavigationList" asChild>
